...
class PalEditWindow(tk.Toplevel):
    ...
    def create_widgets(self):
        ...
        self.exp_entry.pack(
            ...
            anchor=tk.E,
            fill=tk.X,
            ipadx=self.parent.recommended_ipadx + 5,
            ipady=self.parent.recommended_ipady,
            # padx=self.parent.recommended_ipadx,
        )
...
class WazaEditWindow(tk.Toplevel):
    ...
    def insert(self):
        ...
        if self.is_equip_waza and len(l) == 4:
            messagebox.showinfo(
                self.parent.parent.l10n.get("Info"),
                self.parent.parent.l10n.get("Equip Waza cannot have more than 4."),
                parent=self,
            )
            self.focus_set()
            return
